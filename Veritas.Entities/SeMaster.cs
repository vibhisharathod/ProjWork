...
namespace Veritas.Entities
{
    ...
    public class SeMaster
    {
        [Key]
        [Required]
        public int SE_ID { get; set; } // int, not null
        [MaxLength(150)]
        public string SE_Name { get; set; } // varchar(150), null
        [MaxLength(50)]
        public string SECode { get; set; } // varchar(50), null
        public int? Branch_ID { get; set; } // int, null
        public int? TM_ID { get; set; } // int, null
        [MaxLength(10)]
        public string Gender { get; set; } // nchar(10), null
